...
service-up:
	...
	PAYMENT_REQUEST_DEVTEST_KEYSETS_JSON="$$keysets_json" PAYMENT_REQUEST_KEYSET_HASH_HMAC_SECRET="$(SERVICE_KEYSET_HASH_HMAC_SECRET)" $(SERVICE_DC) up -d --build postgres app; \
	PAYMENT_REQUEST_DEVTEST_KEYSETS_JSON="$$keysets_json" PAYMENT_REQUEST_KEYSET_HASH_HMAC_SECRET="$(SERVICE_KEYSET_HASH_HMAC_SECRET)" SERVICE_COMPOSE_FILE="$(SERVICE_COMPOSE)" LOCAL_SERVICE_PROJECT="$(SERVICE_PROJECT)" ETH_ARTIFACT_FILE="$(ETH_ARTIFACT)" $(SCRIPT_DIR)/service_sync_catalog.sh
