...
service-up:
	...
	COMPOSE_PROFILES="$$compose_profiles" PAYMENT_REQUEST_DEVTEST_KEYSETS_JSON="$$keysets_json" PAYMENT_REQUEST_KEYSET_HASH_HMAC_SECRET="$(SERVICE_KEYSET_HASH_HMAC_SECRET)" PAYMENT_REQUEST_KEYSET_HASH_HMAC_PREVIOUS_SECRETS_JSON='$(SERVICE_KEYSET_HASH_HMAC_PREVIOUS_SECRETS_JSON)' PAYMENT_REQUEST_APP_RECONCILER_ENABLED="$(SERVICE_APP_RECONCILER_ENABLED)" PAYMENT_REQUEST_APP_RECONCILER_WORKER_ID="$(SERVICE_APP_RECONCILER_WORKER_ID)" PAYMENT_REQUEST_RECONCILER_ENABLED="$(SERVICE_RECONCILER_ENABLED)" PAYMENT_REQUEST_RECONCILER_POLL_INTERVAL_SECONDS="$(SERVICE_RECONCILER_POLL_INTERVAL_SECONDS)" PAYMENT_REQUEST_RECONCILER_BATCH_SIZE="$(SERVICE_RECONCILER_BATCH_SIZE)" PAYMENT_REQUEST_RECONCILER_LEASE_SECONDS="$(SERVICE_RECONCILER_LEASE_SECONDS)" PAYMENT_REQUEST_RECONCILER_WORKER_ID="$(SERVICE_RECONCILER_WORKER_ID)" PAYMENT_REQUEST_RECONCILER_DETECTED_THRESHOLD_BPS="$(SERVICE_RECONCILER_DETECTED_THRESHOLD_BPS)" PAYMENT_REQUEST_RECONCILER_CONFIRMED_THRESHOLD_BPS="$(SERVICE_RECONCILER_CONFIRMED_THRESHOLD_BPS)" PAYMENT_REQUEST_BTC_ESPLORA_BASE_URL="$(SERVICE_BTC_ESPLORA_BASE_URL)" PAYMENT_REQUEST_EVM_RPC_URLS_JSON='$(SERVICE_EVM_RPC_URLS_JSON)' $(SERVICE_DC) up -d --build $$scale_args $$services; \
